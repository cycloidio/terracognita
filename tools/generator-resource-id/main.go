...
func (id ResourceIdGenerator) TestCode() string {
	...
	if id.TestPackageSuffix != "" {
		importLine = fmt.Sprintf("\"github.com/hashicorp/terraform-provider-azurerm/services/%s/parse\"", id.ServicePackageName)
	}
...
import (
	...
	"github.com/hashicorp/terraform-provider-azurerm/services/%[2]s/parse"
)
...
import (
	...
	"github.com/hashicorp/terraform-provider-azurerm/services/%[4]s/validate"
)
