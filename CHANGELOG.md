...
- Added variable IsDatabase in AzureAPI to allow to change FunctionName of database resources, e.g sql or postgresql, from List+PluralName to List+API+PluralName
