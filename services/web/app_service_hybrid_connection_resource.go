...
import (
	...
	relayValidate "github.com/hashicorp/terraform-provider-azurerm/services/relay/validate"
	"github.com/hashicorp/terraform-provider-azurerm/services/web/parse"
	"github.com/hashicorp/terraform-provider-azurerm/services/web/validate"
